...
smiley
	...
	uncertain
		...
		iconstate = "uncertain"
	troll
		smileys = list("Troller","uMad")
		iconstate = "Troll Face"
	PacmanRight
		smileys = list("Pacman","pacman")
		iconstate = "pm1"
	PacmanUp
		smileys = list("Pacman^","pacman^")
		iconstate = "pm2"
	PacmanDown
		smileys = list("Pacmanv","pacmanv")
		iconstate = "pm3"
	PacmanBack
		smileys = list("Pacman<","pacman<")
		iconstate = "pm4"
	...
	dot
		...
		iconstate = "dot"
	WhisperOOC
		smileys = list("999999110293")
		iconstate = "OOCWhisper"
	Bday
		smileys = list("Birthday","first year","Bday")
		iconstate = "BDAY"
	Fangs
		smileys = list("o,.,o","o,,o")
		iconstate = "Fangs"
	Tears
		smileys = list("<,<",">,>",">,<")
		iconstate = "tear"

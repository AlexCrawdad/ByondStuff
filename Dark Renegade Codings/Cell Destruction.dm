...
<table border=0 cellspacing=1 width=492 id=AutoNumber1 height=210>
  ...
  <tr>
    ...
    <td width=143 height=12><font size=1><font face=Tahoma>Kill {NPC}Cell!</font></font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width=143 height=12><font face=Tahoma size=1>Piccolo</font></td>
  </tr>
  <tr>
    <td colspan=4 height=48><font face=Tahoma size=1>Kill Cell or die, take your Pick.</font></td>
  </tr>
</table>
"}
			...
			Abandon_Quest()
				...
				switch(alert("Do you wish to abandon the Quest: [src]?","Abandon Quest","Yes","No"))
					if("Yes")
						if(usr.cell_kill)
							usr<<"You already finished this quest, go talk to Piccolo!"
							return
						else
							usr.cell_fight_start = 0
							del(src)
					if("No")return
		...
		Gravity_Strain()
			...
			spawn while(src.grav)
				...
				if(prob(40))
					...
					if(prob(25))src<<"You feel yourself getting use to the gravity."
					else
						if(prob(30))

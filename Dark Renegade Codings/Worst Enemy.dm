...
<table border=0 cellspacing=1 width=492 id=AutoNumber1 height=210>
  ...
  <tr>
    ...
    <td width=143 height=12><font size=1><font face=Tahoma>Kill Namekian Warriors </font></font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width=143 height=12><font face=Tahoma size=1>Hercule</font></td>
  </tr>
  <tr>
    <td colspan=4 height=48><font face=Tahoma size=1>Hey, [usr]! Kill them monsters for me, and i'll send a whopping boost your way!</font></td>
  </tr>
</table>
...
"}
			...
			Abandon_Quest()
				...
				switch(alert("Do you wish to abandon the Quest: [src]?","Abandon Quest","Yes","No"))
					if("Yes")
						if(usr.NW_kills>=10)
							usr<<"You already finished this quest, go talk to Hercule"
						else
							usr.worst_enemy_start=0
							del(src)
					if("No")return
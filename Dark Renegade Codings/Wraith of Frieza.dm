...
<table border=0 cellspacing=1 width=492 id=AutoNumber1 height=210>
  ...
  <tr>
    <td colspan=4 height=48><font face=Tahoma size=1>Bah! These pesky Namekians
      are starting to tire me. My troops are under attack constantly by this pathetic
      group, but my time is needed elsewhere. You, [usr], will fit the task
      nicely. I'm not requesting this of you, it is an order which I
      want carried out immediately. Now get out of my sight...</font></td>
  </tr>
</table>
"}
				...
				switch(alert("Do you wish to abandon the Quest: [src]?","Abandon Quest","Yes","No"))
					if("Yes")
						if(usr.namek_kills>=3)
							usr<<"You already finished this quest, go talk to Frieza!"
							return
						else

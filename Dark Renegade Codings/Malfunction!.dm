...
<table border=0 cellspacing=1 width=492 id=AutoNumber1 height=210>
  ...
  <tr>
    <td colspan=4 height=48><font face=Tahoma size=1>Hey, [usr]. I've heard that
      my father's been busy at work on one of the new Capsule Corp. spacepods,
      but knowing him, I knew he would neglect to take care of his equipment!
      I need you to run this part over to him, so that he can continue working on
      the spacepod. Thanks a bunch!</font></td>
  </tr>
</table>
"}
			...
			Abandon_Quest()
				...
				switch(alert("Do you wish to abandon the Quest: [src]?","Abandon Quest","Yes","No"))
					if("Yes")
						...
						for(var/obj/Equipment/Spanner/O in contents)del(O)
						del(src)
					if("No")return
...
<table border=0 cellspacing=1 width=492 id=AutoNumber1 height=210>
  ...
  <tr>
    <td colspan=4 height=48><font face=Tahoma size=1>Hey, [usr]! I've been
      watching your training on Earth, and as unforunately it is that you died! It's
      a good thing, because I can offer to teach you a skill to greatly enhance
      your Power, Speed and Defense! But, before I go teaching you this ancient
      technique I made, you will need to prove your worth. All I ask is you catch Bubbles
				...
				switch(alert("Do you wish to abandon the Quest: [src]?","Abandon Quest","Yes","No"))
					if("Yes")
						if(usr.gregory_hit&&usr.bubbles_caught)
							usr<<"You already finished this quest, go talk to King Kai!"
							return
						else

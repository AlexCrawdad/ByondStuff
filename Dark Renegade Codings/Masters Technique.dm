...
<table border=0 cellspacing=1 width=492 id=AutoNumber1 height=210>
  ...
  <tr>
    <td colspan=4 height=48><font face=Tahoma size=1>Well [usr], if you've
      come to me for my skill, the Kamehameha Wave, you're going to have to prove
      you're dedicated enough to learn it. I've thrown a rock somewhere in the world
...
"}
			...
			Abandon_Quest()
				...
				switch(alert("Do you wish to abandon the Quest: [src]?","Abandon Quest","Yes","No"))
					if("Yes")
						if(usr.got_rock)
							usr<<"You already finished this quest, go talk to Master Roshi!"
							return
						else

mob
	proc
		DarkAngelFuseForm()
			...
			src.Big_Aura()
			src.icon_state = ""
			src.icon = 'dark angel - form 8.dmi'
			src.form_1 = 1
			src.form_2 = 1
			src.form_3 = 1
			src.form_4 = 1
		...
		if(!src.form_1)
			if(src.powerlevel_max >= 1000000)
				...
				if(src.speed<1000)
					src.speed=1000
				src.icon_state = ""
				src.icon = 'dark angel - form 1.dmi'
				src.form_1 = 1
				src.frozen = 0
				src.doing = 0
				src.safe = 0
			...
			if(!src.form_2)
				if(src.powerlevel_max >= 10000000)
					...
					if(src.speed<1000)
						src.speed=1000
					src.icon_state = ""
					src.icon = 'dark angel - form 3.dmi'
					src.underlays -= src.underlays
					src.overlays -= src.aura
					src.Big_Aura()
				...
				if(!src.form_3)
					if(src.powerlevel_max >= 2500000)
						...
						if(src.speed<1000)
							src.speed=1000
						src.icon_state = ""
						src.icon = 'dark angel - form 4.dmi'
						src.underlays -= src.underlays
						src.overlays -= src.aura
						src.Big_Aura()
						src.overlays -= 'Elec Demon 1.dmi'
					...
					if(!src.form_4)
						if(src.powerlevel_max >= 5000000)
							...
							if(src.speed<1000)
								src.speed=1000
							src.icon_state = ""
							src.icon = 'dark angel - form 5.dmi'
							src.underlays -= src.underlays
							src.overlays -= src.aura
							src.Big_Aura()
							src.overlays -= 'Elec Demon 2.dmi'
						...
						if(!src.form_5)
							if(src.powerlevel_max >= 10000000)
								...
								if(src.speed<1000)
									src.speed=1000
								src.icon_state = ""
								src.icon = 'dark angel - form 6.dmi'
								src.underlays -= src.underlays
								src.overlays -= src.aura
								src.Big_Aura()
								src.overlays -= 'Elec Demon 2.dmi'
							...
							if(!src.form_6)
								if(src.powerlevel_max >= 2500000)
									...
									if(src.speed<1000)
										src.speed=1000
									src.icon_state = ""
									src.icon = 'dark angel - form 7.dmi'
									src.underlays -= src.underlays
									src.overlays -= src.aura
									src.Big_Aura()
									src.overlays -= 'Elec Demon 2.dmi'

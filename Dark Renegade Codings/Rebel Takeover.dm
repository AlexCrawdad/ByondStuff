...
<table border=0 cellspacing=1 width=492 id=AutoNumber1 height=210>
  ...
  <tr>
    ...
    <td width=143 height=12><font size=1><font face=Tahoma>Kill Gaurds </font></font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width=143 height=12><font face=Tahoma size=1>RebelFriend</font></td>
  </tr>
  <tr>
    <td colspan=4 height=48><font face=Tahoma size=1>Please, Save us! </font></td>
  </tr>
</table>
				...
				switch(alert("Do you wish to abandon the Quest: [src]?","Abandon Quest","Yes","No"))
					if("Yes")
						if(usr.Gaurd_kills>10)
							usr<<"You already finished this quest, go talk to RebelFriend!"
							return
						else
							usr.RebelFriend_start=0
							del(src)
					if("No")return